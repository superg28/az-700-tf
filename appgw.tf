# Setup for AZ AppGW
resource "azurerm_application_gateway" "app-gw-test" {
  name                = "app-gw-test"
  ...
  backend_address_pool {
    ...
    ip_addresses = [
      azurerm_linux_virtual_machine.vm-one.private_ip_address,
      azurerm_linux_virtual_machine.vm-two.private_ip_address
    ]
  }
